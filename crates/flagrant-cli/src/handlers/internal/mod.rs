...
//! - [`effectives`]: computes the effective (committed + staged) variant list.

pub(crate) mod effectives;
pub(crate) mod helpers;
pub(crate) mod index;
pub(crate) mod stage;

pub(crate) use helpers::{concat_values_for_arg, extract_single_value, open_in_editor};
