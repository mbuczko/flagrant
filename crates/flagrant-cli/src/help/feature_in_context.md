...
- `FEATURE progressive rules <w1>:<dur1> ... <100>` - stage a progressive rollout schedule for the feature's single alternative variant (e.g. `FEATURE progressive rules 10:6h 50:2d 80:30m 100`)
...
- `FEATURE progressive off` - stage disabling the progressive rollout
