...
- `VARIANT value [index] [value]` — stage a value change for an existing variant; omit the index to pick from an interactive menu
...
- `VARIANT add 20` - add a variant weighted 20%, prompting inline to type its value
