...
- **VIP pinning**: `FEATURE use theme@alice` then `SET override dark` forces `alice` onto the `dark` variant regardless of the feature's normal weights.
