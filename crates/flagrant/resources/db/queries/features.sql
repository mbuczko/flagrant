...
-- :name update_feature_rollout :<> :!
-- :doc Sets a feature's progressive-rollout rule definitions (raw JSON, or NULL to disable).
UPDATE features SET rollout = $2 WHERE feature_id = $1
